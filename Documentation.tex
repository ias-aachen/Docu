...
headinclude=true, % Kopfzeile nicht zum Textkörper zählen sondern zu Randbereich
footinclude=false, % Kopfzeile nicht zum Textkörper zählen sondern zu Randbereich
...
cleardoublepage = empty, % fügt am ende eines Kapitels eine Leerseite ein und erzwingt das fluschen von floating objekten, da scrbook ein Dokument mit doppelseitigem Layout erstellt. Style Plain nur die Seitenzahl an einer Leeren seite am ende des Kapitels. Empty ohne seitenzahl.
...
\usepackage[latin1]{inputenc} % Hauptsächlich für Umlaute
...
%%-----------------------------------------
%%  Pakete und Einstellungen für pdflatex
%%-----------------------------------------
...
\begin{document}
  ...
  \input{titel-2015.tex}               %Titelseite einfügen
  \cleardoubleemptypage
  \pagestyle{plain}
  \tikzexternaldisable
  %\includepdf[]{Anhang/ErklärungBA.pdf}
  \tikzexternalenable
